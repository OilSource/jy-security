package com.security.jy.core.authentication.filter;
...
public class SmsCodeAuthenticationFilter extends
    ...
    public static final String JY_FORM_USERNAME_KEY = "mobile";

    private String mobileParameter = JY_FORM_USERNAME_KEY;
